...
class _PaymentPageState extends State<PaymentPage> {
  ...
  String get _reservationCode {
    ...
    final train = widget.departureSchedule?.trainNumber.replaceAll(' ', '') ?? 'KTX';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text(
          AppLocalizations.of(context).translate('결제하기'),
  ...
  Widget _buildConfirmation() {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('K-Rail', style: TextStyle(fontWeight: FontWeight.w900)),
      ),
      body: SafeArea(
        child: SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    ...
                    _confirmationLine(
                      ...
                      DateFormat('yyyy.MM.dd').format(schedule.departureTime),
                    ),
                    _confirmationLine(
